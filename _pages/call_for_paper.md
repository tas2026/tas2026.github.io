...
Authors are encouraged to submit earlier rather than later.

## Proceedings

Accepted TAS 2026 papers will be published in the official AAAI Fall Symposium proceedings, provided at least one paper author attends the conference in person. One-page abstracts are non-archival. Camera-ready files for the official AAAI proceedings are collected through the AAAI CRC platform; further instructions will be shared with accepted authors.
